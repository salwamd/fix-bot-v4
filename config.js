...
global.sig = 'https://www.instagram.com/p/CJodhzvnc9t/?igshid=YmMyMTA2M2Y=' // ig
global.sgh = '-' // github
...
/*============== WATERMARK ==============*/
global.wm = '                「 AGA-BOT 」' //Main Watermark
global.wm2 = 'ʕ⁠っ⁠•⁠ᴥ⁠•⁠ʔ⁠っAGAA HOSTʕ⁠っ⁠•⁠ᴥ⁠•⁠ʔ⁠っ'
global.wm3 = '⫹⫺ AGAA '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By JEGA`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 AGA-HOST  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'AGA'
global.stickauth = `By ©JEGA BOT`
